...
class TestByte(TestBase):
    ...
    def test_utf_8(self):
        ...
        _test('(ㅂ ㅂ ㅂㅎㄷ) ㄱㄴㅂㄷㅅㄱㄹㄹㅁㅂㅂㅈㅅㄱㄹㄴㄱㅁㅁㄹㅈㅅㄹㄹㄷㅅㄴㅅㅅㄱㄴㄹㄴㅁㄱ (ㄴ ㅂㄴㄱ ㄱㅇㄱㅎㄷ) (ㄱ ㄴ ㄱㅇㄱㅎㄷ) ㄴㄱㅎㄷㅎㄴ ㅎㅎㄴ', "'Hello, world!'")
        _test('(ㅂ ㅂ ㅂㅎㄷ) ㅂㅂㅈㅈㄱㄹㄷㅁㄹㅂㄹㄴㄹㄴㅂㅁㅂㅂㅈㄷㄴㄴㅈㅁㄱㅁㅁㅅㅅㄹㅂㅁㅁㄹㄷㅂㅅㄴㅅㅂㄱㄱㄷ (ㄴ ㄱㄷㄱ ㄱㅇㄱㅎㄷ) (ㄱ ㄴ ㄱㅇㄱㅎㄷ) ㄴㄱㅎㄷㅎㄴ ㅎㅎㄴ', "'평범한 한글'")

    def test_utf_16(self):
        _test = self._assert_execute
        _test('ㅁㅈㅎㄱ ㄱ ㄷ ㅂ ㅂ ㅂㅎㄷ ㅎㄷ ㅎㄴ', "b'\\xFF\\xFE'")
        _test('ㅁㄴㄱ ㅁㅈㅎㄴ ㄱ ㄷ ㅂ ㅂ ㅂㅎㄷ ㅎㄷ ㅎㄴ', "b'\\xFF\\xFE\\x31\\x00\\x32\\x00'")
    ...
    def test_utf_32(self):
        ...
        _test('ㄴ ㅁㅈㅎㄴ ㄱ ㅁ ㅂ ㅂ ㅂㅎㄷ ㅎㄷ ㅎㄴ', "b'\\xFF\\xFE\\x00\\x00\\x31\\x00\\x00\\x00'")
        _test('ㅁㅈㅎㄱ ㄱ ㅁ ㄱㅈㅎㄱ ㅂ ㅂ ㅂㅎㄷ ㅎㄹ ㅎㄴ', "b''")
        _test('ㅁㄴㄱ ㅁㅈㅎㄴ ㄱ ㅁ ㄱㅈㅎㄱ ㅂ ㅂ ㅂㅎㄷ ㅎㄹ ㅎㄴ', "b'\\x31\\x00\\x00\\x00\\x32\\x00\\x00\\x00'")
        _test('ㅁㅈㅎㄱ ㄱ ㅁ ㅈㅈㅎㄱ ㅂ ㅂ ㅂㅎㄷ ㅎㄹ ㅎㄴ', "b''")
        _test('ㅁㄴㄱ ㅁㅈㅎㄴ ㄱ ㅁ ㅈㅈㅎㄱ ㅂ ㅂ ㅂㅎㄷ ㅎㄹ ㅎㄴ', "b'\\x00\\x00\\x00\\x31\\x00\\x00\\x00\\x32'")
    ...
    def test_swap_endian(self):
        ...
        _test('(ㅂ ㅂ ㅂㅎㄷ) ㅀㄱ (ㄱ ㄷ ㅈㅈㅎㄱ ㄱㅇㄱㅎㄹ) (ㄱ ㄷ ㄱㅈㅎㄱ ㄱㅇㄱㅎㄹ) ㄳ ㄴㄱㅎㄹ ㄱㅀㄷㅎㅎㄴ', "''", '\n', '')
        _test('(ㅂ ㅂ ㅂㅎㄷ) ㅀㄱ (ㄱ ㄷ ㅈㅈㅎㄱ ㄱㅇㄱㅎㄹ) (ㄱ ㄷ ㄱㅈㅎㄱ ㄱㅇㄱㅎㄹ) ㄳ ㄴㄱㅎㄹ ㄱㅀㄷㅎㅎㄴ', "'쮭'", '귋', '')
        _test('(ㅂ ㅂ ㅂㅎㄷ) ㅀㄱ (ㄱ ㄷ ㅈㅈㅎㄱ ㄱㅇㄱㅎㄹ) (ㄱ ㄷ ㄱㅈㅎㄱ ㄱㅇㄱㅎㄹ) ㄳ ㄴㄱㅎㄹ ㄱㅀㄷㅎㅎㄴ', "'쮭붬'", '귋경', '')
        _test('(ㅂ ㅂ ㅂㅎㄷ) ㅀㄱ (ㄱ ㄷ ㄱㅈㅎㄱ ㄱㅇㄱㅎㄹ) (ㄱ ㄷ ㄱㅇㄱㅎㄷ) ㄳ ㄴㄱㅎㄹ ㄱㅀㄷㅎㅎㄴ', "'귋경'", '귋경', '')
        _test('(ㅂ ㅂ ㅂㅎㄷ) ㅀㄱ (ㄱ ㄷ ㅈㅈㅎㄱ ㄱㅇㄱㅎㄹ) (ㄱ ㄷ ㄱㅇㄱㅎㄷ) ㄳ ㄴㄱㅎㄹ ㄱㅀㄷㅎㅎㄴ', "'쮭붬'", '귋경', '')
